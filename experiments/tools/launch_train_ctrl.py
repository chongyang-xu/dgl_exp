...
parser.add_argument('--graph_data_config', type=str, required=True, help='')
...
#    FIRST_N=FIRST_N)
PART_CONF=args.graph_data_config

TRAIN_LAUNCHER="python3 /workspace/dgl_dsg/tools/launch.py --workspace /workspace/dgl_dsg/experiments"
PYTHON_CMD_PATH="python3"

SINGLE_JOB_CMD = "{PYTHON_CMD_PATH} models/train_dist_ctrl.py".format(PYTHON_CMD_PATH=PYTHON_CMD_PATH)
...
SINGLE_JOB_CMD += " --num_gpus {N_GPUS} --ip_config {IP_CONF} --graph_data_config {PART_CONF}".format(
