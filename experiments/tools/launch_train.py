...
PART_CONF="/data/ds_pre/{DS_NAME}/data_part_n{N_PARTS}_{PART_ALGO}_{PART_HOP}_{FIRST_N}/{DS_NAME}.json".format(
...
SINGLE_JOB_CMD = "{PYTHON_CMD_PATH} models/train_dist.py".format(PYTHON_CMD_PATH=PYTHON_CMD_PATH)
#SINGLE_JOB_CMD  = "gdb -x gdb.txt --batch --args {PYTHON_CMD_PATH} models/train_dist.py".format(PYTHON_CMD_PATH=PYTHON_CMD_PATH)
