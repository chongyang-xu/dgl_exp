...
values1 = [12.75*500, 9.69*500, 5.25*500]
values2 = [0.0      , 0.0     , 5.25*100]
values3 = [2568, 6523, 2568*10]
...
ax.set_title('Estimation OGBN papers100M dataset, sage-2, 16 partitions (4 gpus)')
ax.legend()

# Display the plot
plt.savefig("overhead_ogbpa.pdf")
