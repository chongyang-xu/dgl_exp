...
for dataset in ['ogbar']:
    for i in range(3):
        extra_tag = "metis_xno_part_bias_500x"
...
#for dataset in ['ogbar']:
#    for i in range(3):
#        run_training([dataset], [16], -1, ['metis'], [2], ['gcn', 'sage', 'gat'], extra_tag="default", num_halo=1, sampling_strategy="dft")

extra_tag = "random_xno_part_bias_050x"
for idx in range(3):
    run_training_ctrl(['reddit', 'cora',], [16], -1, None, [2], ['gcn', 'sage', 'gat'], extra_tag=extra_tag, switch_mode=3)
exit(0)
