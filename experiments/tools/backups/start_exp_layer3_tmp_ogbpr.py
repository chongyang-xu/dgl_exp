...
EVAL_BATCH_SIZE=50000 # ogbpax16 use 1e3, ogbpr used 1e5
...
#run_training_ctrl(['ogbpr'], [4], -1, None, [2], ['sage', 'gat'], extra_tag="20fmode2")
#run_training_ctrl(['ogbpr'], [16], -1, None, [2], ['gcn', 'sage', 'gat'], extra_tag="20fmode3")
#run_training_ctrl(['ogbpr'], [16], -1, None, [2], ['gcn', 'sage', 'gat'], extra_tag="20fmode4")


#run_training_ctrl(['ogbpr'], [16], -1, None, [3], ['gcn', 'sage'], extra_tag="20fmode2")
#run_training_ctrl(['ogbpr'], [16], -1, None, [3], ['gcn', 'sage'], extra_tag="20fmode3")
#run_training_ctrl(['ogbpr'], [16], -1, None, [3], ['gcn', 'sage'], extra_tag="20fmode4")
#run_training_ctrl(['ogbpr'], [16], -1, None, [3], ['gcn', 'sage'], extra_tag="10fmode2")
#run_training_ctrl(['ogbpr'], [16], -1, None, [3], ['gcn', 'sage'], extra_tag="10mode2")
run_training_ctrl(['ogbpr'], [256], -1, None, [0], ['gcn'], extra_tag="dbg")
