...
TOTAL_MACHINE=8 # totoal number of docker containers == total GPUs
N_EPOCH=500
N_EVAL=500 # evaluate every ...
EVAL_BATCH_SIZE=100000 # ogbpax16 use 1e3, ogbpr used 1e5
...
#run_training_ctrl(['ogbpr'], [64], -1, None, [2], ['gcn', 'sage' ], extra_tag="test")
#run_training_ctrl(['ogbpr'], [64], -1, None, [3], ['gcn', 'sage' ], extra_tag="test")
run_training_ctrl(['ogbpr'], [16], -1, None, [2], ['gcn', 'sage', 'gat' ], extra_tag="test")
run_training_ctrl(['ogbpr'], [4], -1, None, [2], ['gcn', 'sage', 'gat' ], extra_tag="test")

#run_training(['ogbpa'], [4, 16], -1, ['random', 'metis'], [2], ['gcn', 'sage', 'gat'], extra_tag="test", num_halo=1, sampling_strategy="dft")
#run_training(['ogbpa'], [16], -1, ['random', 'metis'], [2], ['gcn', 'sage', 'gat'], extra_tag="test", num_halo=1, sampling_strategy="dft")

#run_training(['ogbpa'], [16], -1, ['random', 'metis'], [2], ['gcn', 'sage', 'gat'], extra_tag="test", num_halo=1, sampling_strategy="bdr")

#run_training(['ogbpa'], [4, 16], -1, ['random', 'metis'], [3], ['gcn', 'sage'], extra_tag="test", num_halo=1, sampling_strategy="dft")

#run_training(['ogbpa'], [4, 16], -1, ['random', 'metis'], [3], ['gcn', 'sage'], extra_tag="test", num_halo=1, sampling_strategy="bdr")
#run_training(['ogbpr'], [4, 16], -1, ['vcoblivious'], [2], ['gat'], extra_tag="test", num_halo=0, sampling_strategy="bdr")

#run_training_ctrl(['ogbpr'], [4, 16], -1, None, [2], ['gcn', 'sage', 'gat'], extra_tag="test")
